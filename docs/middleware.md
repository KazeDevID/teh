...
```javascript
import { onlyPrivate, onlyGroups } from '@mkzstyleee/telega';
...
```javascript
import { createRateLimitPlugin } from '@mkzstyleee/telega';
...
```javascript
import { onUpdateType, onlyUsers, onlyChats } from '@mkzstyleee/telega';
